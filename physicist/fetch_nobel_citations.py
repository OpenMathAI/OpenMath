#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""抓取诺贝尔物理学奖获奖理由（Citation），解析 rowspan 表格结构。

输出：nobel_physics_citations.json
  [
    {"year": 1901, "name": "Wilhelm Conrad Röntgen", "country": "Germany",
...
OUT = ROOT / "nobel_physics_citations.json"

LIST_PAGE = "List of Nobel laureates in Physics"
