...
PEOPLE = {
    ...
    "ep02": [
        ...
        ("Kathryn Roeder", "凯瑟琳·罗德", 1997, "1960–", "美国", "Carnegie Mellon University",
         ...
         "none", "K.R."),
        ("Pascal Massart", "帕斯卡尔·马萨尔 \\enspace·\\enspace 首位法国得主", 1998, "1955–", "法国", "Université de Paris-Sud",
    ...
    "ep03": [
        ...
        ("Michael A. Newton", "迈克尔·牛顿", 2004, "1960–", "美国", "University of Wisconsin",
    ...
    "ep04": [
        ("Nilanjan Chatterjee", "尼兰詹·查特吉 \\enspace·\\enspace 首位印度裔得主", 2011, "1971–", "美国（生于印度）", "Johns Hopkins University",
        ...
        ("Tyler J. VanderWeele", "泰勒·范德维勒", 2017, "1977–", "美国", "Harvard University",
         "因果中介分析", "因果中介分析、直接与间接效应分解、流行病学方法。他是现代因果推断方法论的代表人物。",
        ...
        ("Rina Foygel Barber", "里娜·巴伯 \\enspace·\\enspace 第二位女性得主", 2020, "1983–", "美国", "University of Chicago",
         "选择性推断", "选择性推断、Knockoff 方法、FDR 后选择控制。她为高维回归的选择后推断奠定理论。",
         "none", "R.B."),
    ],
    "ep05": [
        ...
        ("Daniela Witten", "丹妮拉·维滕 \\enspace·\\enspace 第三位女性得主", 2022, "1984–", "美国", "University of Washington",
         "高维无监督学习", "高维无监督学习、稀疏聚类、图模型。她与 Hastie、Tibshirani 合著 ISLR 经典教材。",
         "none", "D.W."),
        ("Ryan Tibshirani", "瑞安·蒂布希拉尼", 2023, "1984–", "美国/加拿大", "UC Berkeley",
         "保形预测与分布推断", "保形预测、分布推断、非参数回归。他推动了分布自由的现代推断方法。",
         "images/tibshirani_ryan.jpg", "Wikipedia"),
        ("Veronika Ročková", "维罗妮卡·罗奇科娃 \\enspace·\\enspace 第四位女性得主", 2024, "—", "美国（生于捷克）", "University of Chicago",
