...
\begin{tikzpicture}[remember picture, overlay]
  ...
  \node[anchor=center, font=\fontsize{20}{25}\selectfont\bfseries, text=coverdark]
    at ([yshift=2.60cm]current page.center) {COPSS 会长奖 · 数据科学、AI 与贝叶斯革新（2021–2026）};
  \node[anchor=center, font=\fontsize{12}{15}\selectfont, text=coverprimary!85!black]
    at ([yshift=1.55cm]current page.center) {COPSS Presidents' Award（考普斯会长奖）· 第 5 集 · 6 位得主};
  ...
  \node[anchor=center, font=\fontsize{9.5}{12.5}\selectfont\bfseries, text=coveramber!58!black]
    at ([yshift=-2.12cm]current page.center) {统计学站上 AI 前沿 · 从 Leek 到 Su};
  \node[anchor=center] at ([yshift=-0.30cm]current page.center) {
    \begin{tikzpicture}[scale=1]
      \node[inner sep=0pt, draw=coverprimary!22, line width=0.2pt] at (-1.64,0.97) {
        \includegraphics[width=1.5cm,height=1.8cm,keepaspectratio]{images/leek.jpg}
      };
      \node[inner sep=0pt, draw=coverprimary!22, line width=0.2pt] at (0.00,0.97) {
        \includegraphics[width=1.5cm,height=1.8cm,keepaspectratio]{images/danielawitten.jpg}
      };
      \node[inner sep=0pt, draw=coverprimary!22, line width=0.2pt] at (1.64,0.97) {
        \includegraphics[width=1.5cm,height=1.8cm,keepaspectratio]{images/tibshirani_ryan.jpg}
      };
      \node[inner sep=0pt, draw=coverprimary!22, line width=0.2pt] at (-1.64,-0.97) {
        \includegraphics[width=1.5cm,height=1.8cm,keepaspectratio]{images/veronikarockova.jpg}
      };
      \node[inner sep=0pt, draw=coverprimary!22, line width=0.2pt] at (0.00,-0.97) {
        \includegraphics[width=1.5cm,height=1.8cm,keepaspectratio]{images/lestermackey.jpg}
      };
      \node[inner sep=0pt, draw=coverprimary!22, line width=0.2pt] at (1.64,-0.97) {
        \includegraphics[width=1.5cm,height=1.8cm,keepaspectratio]{images/weijiesu.jpg}
      };
    \end{tikzpicture}
  };
  \node[anchor=center, font=\fontsize{7.8}{9.6}\selectfont, text=coverprimary!78!black]
    at ([yshift=-2.67cm]current page.center) {主要荣誉：Spiegelman ×2};
  \node[anchor=south, font=\scriptsize, text=coverdark!40]
    at ([yshift=0.38cm]current page.south) {\faIcon{medal}\enspace COPSS Presidents\' Award\enspace|\enspace 2021 – 2026 · 6 位得主};
\end{tikzpicture}
\end{frame}
}
