...
\begin{tikzpicture}[remember picture, overlay]
  ...
  \node[anchor=center, font=\fontsize{20}{25}\selectfont\bfseries, text=coverdark]
    at ([yshift=2.60cm]current page.center) {COPSS 会长奖 · 高维统计与机器学习融合（2011–2020）};
  \node[anchor=center, font=\fontsize{12}{15}\selectfont, text=coverprimary!85!black]
    at ([yshift=1.70cm]current page.center) {COPSS Presidents' Award（考普斯会长奖）· 第 4 集 · 10 位得主};
  ...
  \node[anchor=center, font=\fontsize{9.5}{12.5}\selectfont\bfseries, text=coveramber!58!black]
    at ([yshift=-2.34cm]current page.center) {高维推断与数据科学 · 从 Chatterjee 到 Barber};
  \node[anchor=center] at ([yshift=-0.30cm]current page.center) {
    \begin{tikzpicture}[scale=1]
      \node[inner sep=0pt, draw=coverprimary!22, line width=0.2pt] at (-2.98,0.90) {
        \includegraphics[width=1.35cm,height=1.65cm,keepaspectratio]{images/chatterjee.png}
      };
      \node[inner sep=0pt, draw=coverprimary!22, line width=0.2pt] at (-1.49,0.90) {
        \includegraphics[width=1.35cm,height=1.65cm,keepaspectratio]{images/samuelkou.jpg}
      };
      \node[inner sep=0pt, draw=coverprimary!22, line width=0.2pt] at (0.00,0.90) {
        \includegraphics[width=1.35cm,height=1.65cm,keepaspectratio]{images/marcasuchard.jpg}
      };
      \node[inner sep=0pt, draw=coverprimary!22, line width=0.2pt] at (1.49,0.90) {
        \includegraphics[width=1.35cm,height=1.65cm,keepaspectratio]{images/martinjwainwright.jpg}
      };
      \node[inner sep=0pt, draw=coverprimary!22, line width=0.2pt] at (2.98,0.90) {
        \includegraphics[width=1.35cm,height=1.65cm,keepaspectratio]{images/johndstorey.jpg}
      };
      \node[inner sep=0pt, draw=coverprimary!22, line width=0.2pt] at (-2.98,-0.90) {
        \includegraphics[width=1.35cm,height=1.65cm,keepaspectratio]{images/nicolaimeinshausen.jpg}
      };
      \node[inner sep=0pt, draw=coverprimary!22, line width=0.2pt] at (-1.49,-0.90) {
        \includegraphics[width=1.35cm,height=1.65cm,keepaspectratio]{images/vanderweele.jpg}
      };
      \node[inner sep=0pt, draw=coverprimary!22, line width=0.2pt] at (0.00,-0.90) {
        \includegraphics[width=1.35cm,height=1.65cm,keepaspectratio]{images/samworth.jpg}
      };
      \node[inner sep=0pt, draw=coverprimary!22, line width=0.2pt] at (1.49,-0.90) {
        \includegraphics[width=1.35cm,height=1.65cm,keepaspectratio]{images/wickham.jpg}
      };
      \node[inner sep=0pt, draw=coverprimary!22, line width=0.2pt] at (2.98,-0.90) {
        \includegraphics[width=1.35cm,height=1.65cm,keepaspectratio]{images/rinafoygelbarber.jpg}
      };
    \end{tikzpicture}
  };
  \node[anchor=center, font=\fontsize{7.8}{9.6}\selectfont, text=coverprimary!78!black]
    at ([yshift=-2.89cm]current page.center) {主要荣誉：Spiegelman ×3 · Sloan/Guggenheim ×2 · MacArthur ×1};
  \node[anchor=south, font=\scriptsize, text=coverdark!40]
    at ([yshift=0.38cm]current page.south) {\faIcon{medal}\enspace COPSS Presidents\' Award\enspace|\enspace 2011 – 2020 · 10 位得主};
\end{tikzpicture}
\end{frame}
}
