...
\begin{tikzpicture}[remember picture, overlay]
  ...
  \node[anchor=center, font=\fontsize{20}{25}\selectfont\bfseries, text=coverdark]
    at ([yshift=2.60cm]current page.center) {COPSS 会长奖 · 贝叶斯复兴与计算革命（1991–2000）};
  \node[anchor=center, font=\fontsize{12}{15}\selectfont, text=coverprimary!85!black]
    at ([yshift=1.70cm]current page.center) {COPSS Presidents' Award（考普斯会长奖）· 第 2 集 · 10 位得主};
  ...
  \node[anchor=center, font=\fontsize{9.5}{12.5}\selectfont\bfseries, text=coveramber!58!black]
    at ([yshift=-2.34cm]current page.center) {MCMC、小波与 LASSO · 从 Silverman 到 Fan};
  \node[anchor=center] at ([yshift=-0.30cm]current page.center) {
    \begin{tikzpicture}[scale=1]
      \node[inner sep=0pt, draw=coverprimary!22, line width=0.2pt] at (-2.98,0.90) {
        \includegraphics[width=1.35cm,height=1.65cm,keepaspectratio]{images/silverman.jpg}
      };
      \node[inner sep=0pt, draw=coverprimary!22, line width=0.2pt] at (-1.49,0.90) {
        \includegraphics[width=1.35cm,height=1.65cm,keepaspectratio]{images/reid.jpg}
      };
      \node[inner sep=0pt, draw=coverprimary!22, line width=0.2pt] at (0.00,0.90) {
        \includegraphics[width=1.35cm,height=1.65cm,keepaspectratio]{images/winghungwong.jpg}
      };
      \node[inner sep=0pt, draw=coverprimary!22, line width=0.2pt] at (1.49,0.90) {
        \includegraphics[width=1.35cm,height=1.65cm,keepaspectratio]{images/donoho.jpg}
      };
      \node[inner sep=0pt, draw=coverprimary!22, line width=0.2pt] at (2.98,0.90) {
        \includegraphics[width=1.35cm,height=1.65cm,keepaspectratio]{images/johnstone.jpg}
      };
      \node[inner sep=0pt, draw=coverprimary!22, line width=0.2pt] at (-2.98,-0.90) {
        \includegraphics[width=1.35cm,height=1.65cm,keepaspectratio]{images/tibshirani.jpg}
      };
      \node[inner sep=0pt, draw=coverprimary!22, line width=0.2pt] at (-1.49,-0.90) {
        \includegraphics[width=1.35cm,height=1.65cm,keepaspectratio]{images/kathrynroeder.jpg}
      };
      \node[inner sep=0pt, draw=coverprimary!22, line width=0.2pt] at (0.00,-0.90) {
        \includegraphics[width=1.35cm,height=1.65cm,keepaspectratio]{images/pascalmassart.jpg}
      };
      \node[inner sep=0pt, draw=coverprimary!22, line width=0.2pt] at (1.49,-0.90) {
        \includegraphics[width=1.35cm,height=1.65cm,keepaspectratio]{images/wasserman.png}
      };
      \node[inner sep=0pt, draw=coverprimary!22, line width=0.2pt] at (2.98,-0.90) {
        \includegraphics[width=1.35cm,height=1.65cm,keepaspectratio]{images/fan.jpg}
      };
    \end{tikzpicture}
  };
  \node[anchor=center, font=\fontsize{7.8}{9.6}\selectfont, text=coverprimary!78!black]
    at ([yshift=-2.89cm]current page.center) {主要荣誉：Guy ×3 · 高斯/邵逸夫 ×1 · Fisher ×2 · IMO ×1};
  \node[anchor=south, font=\scriptsize, text=coverdark!40]
    at ([yshift=0.38cm]current page.south) {\faIcon{medal}\enspace COPSS Presidents\' Award\enspace|\enspace 1991 – 2000 · 10 位得主};
\end{tikzpicture}
\end{frame}
}
