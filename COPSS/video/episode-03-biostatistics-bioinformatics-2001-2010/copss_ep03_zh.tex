...
\begin{tikzpicture}[remember picture, overlay]
  ...
  \node[anchor=center, font=\fontsize{17}{22}\selectfont\bfseries, text=coverdark]
    at ([yshift=2.60cm]current page.center) {COPSS 会长奖 · 生物统计爆发与华人崛起（2001–2010）};
  \node[anchor=center, font=\fontsize{12}{15}\selectfont, text=coverprimary!85!black]
    at ([yshift=1.80cm]current page.center) {COPSS Presidents' Award（考普斯会长奖）· 第 3 集 · 10 位得主};
  ...
  \node[anchor=center, font=\fontsize{9.5}{12.5}\selectfont\bfseries, text=coveramber!58!black]
    at ([yshift=-2.34cm]current page.center) {基因组时代与统计计算 · 从 Meng 到 Dunson};
  \node[anchor=center] at ([yshift=-0.30cm]current page.center) {
    \begin{tikzpicture}[scale=1]
      \node[inner sep=0pt, draw=coverprimary!22, line width=0.2pt] at (-2.98,0.90) {
        \includegraphics[width=1.35cm,height=1.65cm,keepaspectratio]{images/xiaolimeng.jpg}
      };
      \node[inner sep=0pt, draw=coverprimary!22, line width=0.2pt] at (-1.49,0.90) {
        \includegraphics[width=1.35cm,height=1.65cm,keepaspectratio]{images/junliu.jpg}
      };
      \node[inner sep=0pt, draw=coverprimary!22, line width=0.2pt] at (0.00,0.90) {
        \includegraphics[width=1.35cm,height=1.65cm,keepaspectratio]{images/gelman.jpg}
      };
      \node[inner sep=0pt, draw=coverprimary!22, line width=0.2pt] at (1.49,0.90) {
        \includegraphics[width=1.35cm,height=1.65cm,keepaspectratio]{images/michaelanewton.jpg}
      };
      \node[inner sep=0pt, draw=coverprimary!22, line width=0.2pt] at (2.98,0.90) {
        \includegraphics[width=1.35cm,height=1.65cm,keepaspectratio]{images/markjvanderlaan.jpg}
      };
      \node[inner sep=0pt, draw=coverprimary!22, line width=0.2pt] at (-2.98,-0.90) {
        \includegraphics[width=1.35cm,height=1.65cm,keepaspectratio]{images/lin.jpg}
      };
      \node[inner sep=0pt, draw=coverprimary!22, line width=0.2pt] at (-1.49,-0.90) {
        \includegraphics[width=1.35cm,height=1.65cm,keepaspectratio]{images/rosenthal.jpg}
      };
      \node[inner sep=0pt, draw=coverprimary!22, line width=0.2pt] at (0.00,-0.90) {
        \includegraphics[width=1.35cm,height=1.65cm,keepaspectratio]{images/cai.jpg}
      };
      \node[inner sep=0pt, draw=coverprimary!22, line width=0.2pt] at (1.49,-0.90) {
        \includegraphics[width=1.35cm,height=1.65cm,keepaspectratio]{images/rafaelirizarry.jpg}
      };
      \node[inner sep=0pt, draw=coverprimary!22, line width=0.2pt] at (2.98,-0.90) {
        \includegraphics[width=1.35cm,height=1.65cm,keepaspectratio]{images/daviddunson.jpg}
      };
    \end{tikzpicture}
  };
  \node[anchor=center, font=\fontsize{7.8}{9.6}\selectfont, text=coverprimary!78!black]
    at ([yshift=-2.89cm]current page.center) {主要荣誉：晨兴数学金奖 ×1};
  \node[anchor=south, font=\scriptsize, text=coverdark!40]
    at ([yshift=0.38cm]current page.south) {\faIcon{medal}\enspace COPSS Presidents\' Award\enspace|\enspace 2001 – 2010 · 10 位得主};
\end{tikzpicture}
\end{frame}
}
