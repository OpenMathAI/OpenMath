#!/usr/bin/env python3
"""
Download all COPSS Presidents' Award winners' Wikipedia pages (with images) for offline browsing.

Output: pages/<Year>/<Winner Name>/index.html  (+ images/)

Usage:
  python3 fetch_copss.py            # download all 46 winners
  python3 fetch_copss.py --rate 2.0  # set request interval
  python3 fetch_copss.py --no-images # HTML only, no images
...
# ---------------------------------------------------------------------------
# COPSS Presidents' Award winners (1981-2026, 46 winners)
# ---------------------------------------------------------------------------
WINNERS = [
    # (Year, Wikipedia title, display name for note)
    (1981, "Peter J. Bickel", ""),
    (1982, "Stephen Fienberg", ""),
    (1983, "Tze Leung Lai", ""),
    ...
    (1997, "Kathryn Roeder", ""),
    (1998, "Pascal Massart", ""),
    (1999, "Larry A. Wasserman", ""),
    (2000, "Jianqing Fan", ""),
    (2001, "Xiao-Li Meng", ""),
    (2002, "Jun S. Liu", ""),
    (2003, "Andrew Gelman", ""),
    (2004, "Michael A. Newton", ""),
    ...
    (2012, "Samuel Kou", ""),
    (2013, "Marc A. Suchard", ""),
    (2014, "Martin J. Wainwright", ""),
    (2015, "John D. Storey", ""),
    (2016, "Nicolai Meinshausen", ""),
    (2017, "Tyler VanderWeele", ""),
    (2018, "Richard Samworth", ""),
    (2019, "Hadley Wickham", ""),
    (2020, "Rina Foygel Barber", ""),
    (2021, "Jeffrey T. Leek", ""),
    (2022, "Daniela Witten", ""),
    (2023, "Ryan Tibshirani", ""),
    (2024, "Veronika Ročková", ""),
    (2025, "Lester Mackey", ""),
    (2026, "Weijie Su", ""),
]
...
<p>Source: <a href="https://{lang}.wikipedia.org/wiki/{title}">Wikipedia</a> · COPSS Presidents' Award winner · Downloaded for offline reading</p>
</footer>
</body>
</html>"""
...
def generate_index():
    lines = [
        ...
        "<title>COPSS Presidents' Award Winners · Wikipedia Offline</title>",
        "<style>",
        ...
        "</style></head><body>",
        f"<h1>📊 COPSS Presidents' Award Winners ({1981}-{2026})</h1>",
    ...
    lines.append(
        "<footer><p>Source: Wikipedia · COPSS Presidents' Award winners · Offline archive</p></footer>"
    )
...
# ---------------------------------------------------------------------------
def main():
    parser = argparse.ArgumentParser(description="Download COPSS Presidents' Award winners' Wikipedia pages")
    ...
    print(f"  COPSS Presidents' Award Winners: {total} pages", file=sys.stderr)
