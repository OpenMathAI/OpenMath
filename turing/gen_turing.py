...
CROSS_TABLE = [
    ...
    ("★★ 双奖 · 图灵 + 哥德尔奖", [
        ("Shafi Goldwasser", "沙菲·戈德瓦瑟", 2012, "哥德尔奖 1993 / 2001", "美国/以色列", "零知识证明"),
        ("Silvio Micali", "西尔维奥·米卡利", 2012, "哥德尔奖 1993", "意大利/美国", "零知识证明"),
    ]),
    ("★★ 双奖 · 图灵 + IEEE 香农奖", [
    ...
    ("★★ 双奖 · 图灵 + 日本国际奖", [
        ...
        ("Geoffrey Hinton", "杰弗里·辛顿", 2018, "日本国际奖 2016", "英国/加拿大", "深度学习"),
    ]),
    ("★★ 双奖 · 图灵 + 内万林纳奖", [
        ("Leslie Valiant", "莱斯利·瓦利安特", 2010, "内万林纳奖 1986", "英国/美国", "PAC 学习"),
    ]),
    ("★★ 双奖 · 图灵 + 马可尼奖", [
    ...
    ("★★ 双奖 · 图灵 + 千禧科技奖", [
        ("Tim Berners-Lee", "蒂姆·伯纳斯-李", 2016, "千禧科技奖 2004", "英国", "万维网"),
    ]),
    ("其他重要荣誉 · 国家级 / 院士（Ⅰ）", [
