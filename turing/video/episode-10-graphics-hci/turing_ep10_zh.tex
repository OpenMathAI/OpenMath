...
\newcommand{\ivansutherlandslide}{\gdef\personhonors{\kyotobadge 京都奖 \enspace \neumannbadge 冯·诺依曼奖 1998}\personslide
  {Ivan Sutherland\kyotobadge\neumannbadge}{伊万·萨瑟兰}
  {images/ivansutherland.jpg}{Wikipedia}
  {1988（50岁）}{1938–}{美国}{—}
  {Sketchpad 交互式图形系统，计算机图形学之父。\\\textbf{主要荣誉}\\京都奖 \\ IEEE 冯诺依曼奖 1998}}

\newcommand{\douglasengelbartslide}{\gdef\personhonors{}\personslide
  {Douglas Engelbart}{道格拉斯·恩格尔巴特}
  {images/douglasengelbart.jpg}{Wikipedia}
  {1997（72岁）}{1925–2013（享年88岁）}{美国}{—}
  {鼠标发明者、超文本、图形交互（NLS）。}}

\newcommand{\charlespthackerslide}{\gdef\personhonors{}\personslide
  {Charles P. Thacker}{查尔斯·萨克}
  {images/charlespthacker.jpg}{Wikipedia}
  {2009（66岁）}{1943–2017（享年74岁）}{美国}{Microsoft Research}
  {Alto 个人电脑、以太网、平板显示。}}

\newcommand{\edwincatmullslide}{\gdef\personhonors{}\personslide
  {Edwin Catmull}{埃德温·卡特穆尔}
  {images/edwincatmull.jpg}{Wikipedia}
  {2019（74岁）}{1945–}{美国}{Pixar}
  {计算机图形学、纹理映射、皮克斯联合创始人。}}

\newcommand{\pathanrahanslide}{\gdef\personhonors{}\personslide
  {Pat Hanrahan}{帕特·汉拉汉}
