...
\newcommand{\andrewyaoslide}{\gdef\personhonors{\kyotobadge 京都奖 2012 \enspace \nsmbadge 国家科学奖章}\personslide
...
\newcommand{\ronaldrivestslide}{\gdef\personhonors{}\personslide
  {Ronald Rivest}{罗纳德·里维斯特}
  {images/ronaldrivest.jpg}{Wikipedia}
  {2002（55岁）}{1947–}{美国}{MIT}
  {RSA 公钥密码学三杰之一。}}

\newcommand{\adishamirslide}{\gdef\personhonors{}\personslide
  {Adi Shamir}{阿迪·沙米尔}
...
\newcommand{\whitfielddiffieslide}{\gdef\personhonors{\shannonbadge 香农奖 2021 \enspace \marconibadge 马可尼奖}\personslide
...
\newcommand{\martinhellmanslide}{\gdef\personhonors{\shannonbadge 香农奖 2021 \enspace \marconibadge 马可尼奖}\personslide
  {Martin Hellman\shannonbadge\marconibadge}{马丁·赫尔曼}
  {images/martinhellman.jpg}{Wikipedia}
  {2015（70岁）}{1945–}{美国}{Stanford University}
  {公钥密码学（Diffie-Hellman 密钥交换）。\\\textbf{主要荣誉}\\马可尼奖 \\ IEEE 香农奖 2021}}

\newcommand{\charleshbennettslide}{\gdef\personhonors{}\personslide
  {Charles H. Bennett}{查尔斯·贝内特}
  {images/charleshbennett.jpg}{Wikipedia}
  {2025（82岁）}{1943–}{美国}{IBM}
  {量子信息科学、BB84 量子密钥分发、可逆计算。}}

\newcommand{\gillesbrassardslide}{\gdef\personhonors{}\personslide
