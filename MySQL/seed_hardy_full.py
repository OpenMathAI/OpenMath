#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""补全 G.H. Hardy 数据库字段（第 0.5 步，§21.5）。奖项由 seed_all_awards 全量补。幂等。"""
import json
...
PEOPLE_UPDATE = {
    "name_zh": "戈弗雷·哈罗德·哈代",
    "name_variants": json.dumps(["纯数学的捍卫者", "拉马努金的发现者", "G.H. Hardy", "哈代"], ensure_ascii=False),
    "gender": "male",
...
PERSON_FIELDS = ["number theory", "mathematical analysis", "pure mathematics"]
PERSON_INSTITUTIONS = [
    ("Trinity College", "剑桥大学三一学院", "education", None, None),
    ("University of Cambridge", "剑桥大学", "education", None, None),
    ("Winchester College", "温切斯特公学", "education", None, None),
    ("University of Cambridge", "剑桥大学", "employment", 1906, 1919),
    ("University of Oxford", "牛津大学", "employment", 1919, 1931),
    ("University of Cambridge", "剑桥大学", "employment", 1931, 1945),
]
