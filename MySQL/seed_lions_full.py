#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""补全 Jacques-Louis Lions 数据库字段（第 0.5 步，§21.5）。奖项由 seed_all_awards 全量补。幂等。"""
import json
from db_mysql import get_conn

NAME = "Jacques-Louis Lions"
PEOPLE_UPDATE = {
    "name_zh": "雅克-路易·利翁",
    "name_variants": json.dumps(["变分不等式的创立者", "PDE 帝国的建筑师", "最优控制之父"], ensure_ascii=False),
    "gender": "male",
    "birth_date": "1928-05-02",
    "death_date": "2001-05-17",
    "description": "French mathematician (1928–2001)",
}
PERSON_OCCUPATIONS = [("mathematician", 0), ("university teacher", 1), ("professor", 2)]
PERSON_FIELDS = ["partial differential equation", "mathematical analysis", "numerical analysis", "stochastic process", "mathematics"]
PERSON_INSTITUTIONS = [
    ...
    ("Nancy-Université", "南锡大学", "employment", 1954, 1963),
    ("University of Paris", "巴黎大学", "employment", 1963, 1966),
    ("École Polytechnique", "巴黎综合理工学院", "employment", 1966, 1973),
    ("Collège de France", "法兰西公学院", "employment", 1973, 1998),
]
