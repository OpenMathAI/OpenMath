#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""补全 William Thurston 数据库字段（第 0.5 步，§21.5）。奖项由 seed_all_awards 全量补。幂等。"""
import json
...
PEOPLE_UPDATE = {
    "name_zh": "威廉·瑟斯顿",
    "name_variants": json.dumps(["几何化猜想之父", "双曲几何之王", "几何直观的宗师"], ensure_ascii=False),
    "gender": "male",
    "birth_date": "1946-10-30",
    "death_date": "2012-08-21",
    "description": "American mathematician (1946–2012)",
}
PERSON_OCCUPATIONS = [("mathematician", 0), ("topologist", 1), ("university teacher", 2)]
PERSON_FIELDS = ["topology", "mathematics"]
PERSON_INSTITUTIONS = [
    ("University of California, Berkeley", "加州大学伯克利分校", "education", None, None),
    ("New College of Florida", "佛罗里达新学院", "education", None, None),
    ("Cornell University", "康奈尔大学", "employment", 1974, 1979),
    ("University of California, Davis", "加州大学戴维斯分校", "employment", 1971, 1973),
    ("University of California, Berkeley", "加州大学伯克利分校", "employment", 1979, 1992),
    ("Princeton University", "普林斯顿大学", "employment", 1992, 2003),
    ("Cornell University", "康奈尔大学", "employment", 2003, 2012),
]
