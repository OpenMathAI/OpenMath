#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""补全 Atle Selberg 数据库字段（第 0.5 步，§21.5）。奖项由 seed_all_awards 全量补。幂等。"""
import json
from db_mysql import get_conn

NAME = "Atle Selberg"
PEOPLE_UPDATE = {
    "name_variants": json.dumps(["素数定理初等证明者", "Selberg 迹公式", "Selberg 类"], ensure_ascii=False),
    "gender": "male",
    "birth_date": "1917-06-14",
    "death_date": "2007-08-06",
    "description": "Norwegian mathematician (1917–2007)",
}
PERSON_OCCUPATIONS = [("mathematician", 0), ("university teacher", 1)]
PERSON_FIELDS = ["number theory", "mathematics"]
PERSON_INSTITUTIONS = [
    ("University of Oslo", "奥斯陆大学", "education", None, None),
    ("Syracuse University", "雪城大学", "employment", 1947, 1948),
    ("Institute for Advanced Study", "普林斯顿高等研究院", "employment", 1949, 2007),
]
NATIONALITIES = ["Norway", "United States"]
