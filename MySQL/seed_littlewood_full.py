#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""补全 J.E. Littlewood 数据库字段（第 0.5 步，§21.5）。奖项由 seed_all_awards 全量补。幂等。"""
import json
from db_mysql import get_conn

NAME = "J.E. Littlewood"
PEOPLE_UPDATE = {
    "name_zh": "约翰·埃登瑟·李特尔伍德",
    "name_variants": json.dumps(["哈代-李特尔伍德公式的合著者", "分析学派双子星之一"], ensure_ascii=False),
    "gender": "male",
    "birth_date": "1885-06-09",
    "death_date": "1977-09-06",
    "description": "English mathematician (1885–1977)",
}
PERSON_OCCUPATIONS = [("mathematician", 0), ("university teacher", 1)]
PERSON_FIELDS = ["mathematical analysis", "number theory", "differential equations"]
PERSON_INSTITUTIONS = [
    ("Trinity College", "剑桥大学三一学院", "education", None, None),
    ("St Paul's School", "圣保罗学校", "education", None, None),
    ("University of Cambridge", "剑桥大学", "education", None, None),
    ("Victoria University of Manchester", "曼彻斯特大学", "employment", 1907, 1910),
    ("University of Cambridge", "剑桥大学", "employment", 1910, 1950),
]
