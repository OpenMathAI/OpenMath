#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""补全 Lars Ahlfors 数据库字段（第 0.5 步，§21.5）。奖项由 seed_all_awards 全量补。幂等。"""
import json
...
PEOPLE_UPDATE = {
    "name_zh": "拉斯·阿尔福斯",
    "name_variants": json.dumps(["首届菲尔兹奖得主", "拟共形映射之父", "芬兰复分析学派"], ensure_ascii=False),
    "gender": "male",
    "birth_date": "1907-04-18",
    "death_date": "1996-10-11",
    "description": "Finnish mathematician (1907–1996)",
}
PERSON_OCCUPATIONS = [("mathematician", 0), ("university teacher", 1)]
PERSON_FIELDS = ["complex analysis", "mathematical analysis", "function theory", "mathematics"]
PERSON_INSTITUTIONS = [
    ("University of Helsinki", "赫尔辛基大学", "education", None, None),
    ("University of Zurich", "苏黎世大学", "education", None, None),
    ("University of Paris", "巴黎大学", "education", None, None),
    ("University of Helsinki", "赫尔辛基大学", "employment", 1938, 1946),
    ("Harvard University", "哈佛大学", "employment", 1946, 1977),
    ("ETH Zurich", "苏黎世联邦理工学院", "employment", None, None),
]
NATIONALITIES = ["Grand Duchy of Finland", "Russian Empire", "Finland", "United States"]
