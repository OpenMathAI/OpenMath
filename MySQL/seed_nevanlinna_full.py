#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""补全 Rolf Nevanlinna 数据库字段（第 0.5 步，§21.5）。奖项由 seed_all_awards 全量补。幂等。"""
import json
...
PEOPLE_UPDATE = {
    "name_zh": "罗尔夫·奈万林纳",
    "name_variants": json.dumps(["Nevanlinna 理论", "芬兰复分析学派宗师", "值分布理论之父"], ensure_ascii=False),
    "gender": "male",
    "birth_date": "1895-10-22",
    "death_date": "1980-05-28",
    "description": "Finnish mathematician (1895–1980)",
}
PERSON_OCCUPATIONS = [("mathematician", 0), ("university teacher", 1)]
PERSON_FIELDS = ["complex analysis", "mathematics"]
PERSON_INSTITUTIONS = [
    ("University of Helsinki", "赫尔辛基大学", "education", None, None),
    ("University of Helsinki", "赫尔辛基大学", "employment", 1926, 1946),
    ("ETH Zurich", "苏黎世联邦理工学院", "employment", 1946, 1963),
    ("University of Turku", "图尔库大学", "employment", None, None),
]
NATIONALITIES = ["Grand Duchy of Finland", "Finland"]
