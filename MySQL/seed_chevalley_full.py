#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""补全 Claude Chevalley 数据库字段（第 0.5 步，§21.5）。奖项由 seed_all_awards 全量补。幂等。"""
import json
from db_mysql import get_conn

NAME = "Claude Chevalley"
PEOPLE_UPDATE = {
    "name_variants": json.dumps(["布尔巴基创始人之一", "Chevalley 群之父", "代数群理论的奠基者"], ensure_ascii=False),
    "gender": "male",
    "birth_date": "1909-02-11",
    "death_date": "1984-06-28",
    "description": "French mathematician (1909–1984)",
}
...
PERSON_INSTITUTIONS = [
    ...
    ("University of Marburg", "马尔堡大学", "education", None, None),
    ("University of Paris", "巴黎大学", "education", None, None),
    ("Princeton University", "普林斯顿大学", "employment", 1948, 1955),
    ("Columbia University", "哥伦比亚大学", "employment", 1955, 1977),
    ("University of Paris", "巴黎大学", "employment", 1957, 1970),
]
