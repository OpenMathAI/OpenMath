#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""补全 Michael Atiyah 数据库字段（第 0.5 步，§21.5）。奖项由 seed_all_awards 全量补。幂等。"""
import json
...
PEOPLE_UPDATE = {
    "name_zh": "迈克尔·阿蒂亚",
    "name_variants": json.dumps(["指标定理之王", "几何与分析的大祭司", "杨振宁-米尔斯方程解谜人"], ensure_ascii=False),
    "gender": "male",
    "birth_date": "1929-04-22",
    "death_date": "2019-01-11",
    "description": "British mathematician (1929–2019)",
}
PERSON_OCCUPATIONS = [("mathematician", 0), ("topologist", 1), ("university teacher", 2)]
PERSON_FIELDS = ["topology", "mathematics", "geometry"]
PERSON_INSTITUTIONS = [
    ("Trinity College", "剑桥大学三一学院", "education", None, None),
    ("University of Cambridge", "剑桥大学", "education", None, None),
    ("The Manchester Grammar School", "曼彻斯特文法学校", "education", None, None),
    ("University of Cambridge", "剑桥大学", "employment", 1955, 1961),
    ("University of Oxford", "牛津大学", "employment", 1961, 1969),
    ("Institute for Advanced Study", "普林斯顿高等研究院", "employment", 1969, 1972),
    ("University of Oxford", "牛津大学", "employment", 1972, 1997),
    ("University of Edinburgh", "爱丁堡大学", "employment", 1997, 2019),
]
