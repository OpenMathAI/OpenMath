#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""丹尼斯·里奇 (Dennis Ritchie) 人物主记录 + 研究领域入库（对应提示词第 4 步）。

- 新建/更新 people 主记录：name_en='Dennis Ritchie'、name_zh='丹尼斯·里奇'、
...
- 国籍：United States（美国）
- 研究领域：4 大领域写入 fields + person_field（带 rank，编程语言最高）

数据来源：本地 Wikipedia (turing/pages/1983/Dennis Ritchie/index.html) infobox + 正文。
"""
...
FIELDS = [
    ("programming languages", "编程语言", 0),
    ("operating systems", "操作系统", 1),
    ("systems software", "系统软件", 2),
    ("cryptography and theory", "密码学与计算理论", 3),
]
...
def main():
    ...
    if row:
        ...
        cur.execute(
            ...
            "WHERE id=%s",
            (QID, "丹尼斯·里奇", "male", "1941-09-09", "2011-10-12",
             "American computer scientist; creator of the C programming language and co-creator of Unix (1941–2011)",
        ...
        cur.execute(
            ...
            (QID, NAME, "丹尼斯·里奇", "male", "1941-09-09", "2011-10-12",
             "American computer scientist; creator of the C programming language and co-creator of Unix (1941–2011)",
             "computer scientist"),
        )
        pid = cur.lastrowid
