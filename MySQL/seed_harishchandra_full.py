#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""补全 Harish-Chandra 数据库字段（第 0.5 步，§21.5）。奖项由 seed_all_awards 全量补。幂等。"""
import json
...
PEOPLE_UPDATE = {
    "name_zh": "哈里什-钱德拉",
    "name_variants": json.dumps(["半单李群表示论之王", "Harish-Chandra 互反律", "分析学的隐者"], ensure_ascii=False),
    "gender": "male",
    "birth_date": "1923-10-11",
    "death_date": "1983-10-16",
    "description": "Indian-American mathematician (1923–1983)",
}
PERSON_OCCUPATIONS = [("mathematician", 0), ("physicist", 1), ("university teacher", 2)]
PERSON_FIELDS = ["representation theory", "harmonic analysis", "Lie group", "mathematics", "physics"]
PERSON_INSTITUTIONS = [
    ("University of Allahabad", "阿拉哈巴德大学", "education", None, None),
    ("University of Cambridge", "剑桥大学", "education", None, None),
    ("Tata Institute of Fundamental Research", "塔塔基础研究所", "education", None, None),
    ("Institute for Advanced Study", "普林斯顿高等研究院", "employment", 1947, 1983),
    ("Harvard University", "哈佛大学", "employment", 1950, 1955),
    ("Columbia University", "哥伦比亚大学", "employment", 1955, 1964),
]
NATIONALITIES = ["British Raj", "India", "United States", "Dominion of India"]
