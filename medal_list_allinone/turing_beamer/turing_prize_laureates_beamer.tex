...
\begin{tikzpicture}
  \node[fill=nsmclr, rounded corners=3pt, text width=2.8cm, minimum height=0.55cm,
    ...
    {\fontsize{4.5}{5.5}\selectfont\bfseries\color{white}$\spadesuit$\;\; 国家科学奖章\;\; 15人};
  \node[anchor=north west, text width=7.7cm, align=left,
        font=\fontsize{4.5}{5.5}\selectfont\bfseries, text=nsmclr!65!black]
    at (3.05,-0.20) {Marvin Minsky\;·\;John McCarthy\;·\;Donald Knuth\;·\;Herbert A. Simon\;·\;John Backus \\ Richard Karp\;·\;William Kahan\;·\;Andrew Yao\;·\;Vint Cerf\;·\;Barbara Liskov \\ Judea Pearl\;·\;Leslie Lamport\;·\;Yann LeCun\;·\;Jack Dongarra\;·\;Robert Metcalfe};
  \node[fill=kyotoclr, rounded corners=3pt, text width=2.8cm, minimum height=0.55cm,
        inner sep=0pt, align=center, anchor=north west] at (0,-0.71)
    {\fontsize{4.5}{5.5}\selectfont\bfseries\color{white}$\blacklozenge$\;\; 京都\;\; 7人};
  \node[anchor=north west, text width=7.7cm, align=left,
        font=\fontsize{4.5}{5.5}\selectfont\bfseries, text=kyotoclr!65!black]
    at (3.05,-0.91) {John McCarthy\;·\;Donald Knuth\;·\;Tony Hoare\;·\;Richard Karp\;·\;Ivan Sutherland \\ Andrew Yao\;·\;Alan Kay};
  \node[fill=japanclr, rounded corners=3pt, text width=2.8cm, minimum height=0.55cm,
        inner sep=0pt, align=center, anchor=north west] at (0,-1.26)
    {\fontsize{4.5}{5.5}\selectfont\bfseries\color{white}$\heartsuit$\;\; 日本国际\;\; 5人};
  \node[anchor=north west, text width=7.7cm, align=left,
        font=\fontsize{4.5}{5.5}\selectfont\bfseries, text=japanclr!65!black]
    at (3.05,-1.46) {Marvin Minsky\;·\;Dennis Ritchie\;·\;Ken Thompson\;·\;Vint Cerf\;·\;Geoffrey Hinton};
  \node[fill=frsclr, rounded corners=3pt, text width=2.8cm, minimum height=0.55cm,
        inner sep=0pt, align=center, anchor=north west] at (0,-1.81)
    {\fontsize{4.5}{5.5}\selectfont\bfseries\color{white}$\checkmark$\;\; 皇家学会院士\;\; 5人};
  \node[anchor=north west, text width=7.7cm, align=left,
        font=\fontsize{4.5}{5.5}\selectfont\bfseries, text=frsclr!65!black]
    at (3.05,-2.01) {Adi Shamir\;·\;Tim Berners-Lee\;·\;Geoffrey Hinton\;·\;Yann LeCun\;·\;Yoshua Bengio};
  \node[fill=shannonclr, rounded corners=3pt, text width=2.8cm, minimum height=0.55cm,
        inner sep=0pt, align=center, anchor=north west] at (0,-2.36)
    {\fontsize{4.5}{5.5}\selectfont\bfseries\color{white}$\bigstar$\;\; 香农\;\; 4人};
  \node[anchor=north west, text width=7.7cm, align=left,
        font=\fontsize{4.5}{5.5}\selectfont\bfseries, text=shannonclr!65!black]
    at (3.05,-2.56) {Richard Hamming\;·\;Martin Hellman\;·\;Whitfield Diffie\;·\;Charles H. Bennett};
  \node[fill=marconiclr, rounded corners=3pt, text width=2.8cm, minimum height=0.55cm,
        inner sep=0pt, align=center, anchor=north west] at (0,-2.91)
    {\fontsize{4.5}{5.5}\selectfont\bfseries\color{white}$\bullet$\;\; 马可尼\;\; 4人};
  \node[anchor=north west, text width=7.7cm, align=left,
        font=\fontsize{4.5}{5.5}\selectfont\bfseries, text=marconiclr!65!black]
    at (3.05,-3.11) {Ronald Rivest\;·\;Vint Cerf\;·\;Martin Hellman\;·\;Whitfield Diffie};
  \node[fill=neumannclr, rounded corners=3pt, text width=2.8cm, minimum height=0.55cm,
        inner sep=0pt, align=center, anchor=north west] at (0,-3.46)
    {\fontsize{4.5}{5.5}\selectfont\bfseries\color{white}$\blacktriangle$\;\; 冯\;\; 3人};
  \node[anchor=north west, text width=7.7cm, align=left,
        font=\fontsize{4.5}{5.5}\selectfont\bfseries, text=neumannclr!65!black]
    at (3.05,-3.66) {Ken Thompson\;·\;Ivan Sutherland\;·\;Leslie Lamport};
  \node[fill=wolfclr, rounded corners=3pt, text width=2.8cm, minimum height=0.55cm,
        inner sep=0pt, align=center, anchor=north west] at (0,-4.01)
    {\fontsize{4.5}{5.5}\selectfont\bfseries\color{white}$\bigstar$\;\; 沃尔夫\;\; 3人};
  \node[anchor=north west, text width=7.7cm, align=left,
        font=\fontsize{4.5}{5.5}\selectfont\bfseries, text=wolfclr!65!black]
    at (3.05,-4.21) {Adi Shamir\;·\;Charles H. Bennett\;·\;Gilles Brassard};
  \node[fill=godelclr, rounded corners=3pt, text width=2.8cm, minimum height=0.55cm,
        inner sep=0pt, align=center, anchor=north west] at (0,-4.56)
    {\fontsize{4.5}{5.5}\selectfont\bfseries\color{white}$\diamond$\;\; 哥德尔\;\; 3人};
  \node[anchor=north west, text width=7.7cm, align=left,
        font=\fontsize{4.5}{5.5}\selectfont\bfseries, text=godelclr!65!black]
    at (3.05,-4.76) {Shafi Goldwasser\;·\;Silvio Micali\;·\;Avi Wigderson};
  \node[fill=nobelclr, rounded corners=3pt, text width=2.8cm, minimum height=0.55cm,
        inner sep=0pt, align=center, anchor=north west] at (0,-5.11)
    {\fontsize{4.5}{5.5}\selectfont\bfseries\color{white}\faIcon{award}\;\; 诺贝尔\;\; 2人};
  \node[anchor=north west, text width=7.7cm, align=left,
        font=\fontsize{4.5}{5.5}\selectfont\bfseries, text=nobelclr!65!black]
    at (3.05,-5.31) {Herbert A. Simon\;·\;Geoffrey Hinton};
  \node[fill=eatcsclr, rounded corners=3pt, text width=2.8cm, minimum height=0.55cm,
        inner sep=0pt, align=center, anchor=north west] at (0,-5.66)
    {\fontsize{4.5}{5.5}\selectfont\bfseries\color{white}$\square$\;\; EATCS\;\; 2人};
  \node[anchor=north west, text width=7.7cm, align=left,
        font=\fontsize{4.5}{5.5}\selectfont\bfseries, text=eatcsclr!65!black]
    at (3.05,-5.86) {Richard Karp\;·\;Leslie Valiant};
  \node[fill=nevanclr, rounded corners=3pt, text width=2.8cm, minimum height=0.55cm,
        inner sep=0pt, align=center, anchor=north west] at (0,-6.21)
    {\fontsize{4.5}{5.5}\selectfont\bfseries\color{white}$\blacktriangle$\;\; 内万林纳\;\; 2人};
  \node[anchor=north west, text width=7.7cm, align=left,
        font=\fontsize{4.5}{5.5}\selectfont\bfseries, text=nevanclr!65!black]
    at (3.05,-6.41) {Leslie Valiant\;·\;Avi Wigderson};
  \node[fill=nasclr, rounded corners=3pt, text width=2.8cm, minimum height=0.55cm,
        inner sep=0pt, align=center, anchor=north west] at (0,-6.76)
    {\fontsize{4.5}{5.5}\selectfont\bfseries\color{white}$\blacksquare$\;\; 科学院院士\;\; 2人};
  \node[anchor=north west, text width=7.7cm, align=left,
        font=\fontsize{4.5}{5.5}\selectfont\bfseries, text=nasclr!65!black]
    at (3.05,-6.96) {Shafi Goldwasser\;·\;Silvio Micali};
  \node[fill=rumelclr, rounded corners=3pt, text width=2.8cm, minimum height=0.55cm,
        inner sep=0pt, align=center, anchor=north west] at (0,-7.31)
    {\fontsize{4.5}{5.5}\selectfont\bfseries\color{white}$\diamondsuit$\;\; 鲁梅哈特\;\; 1人};
  \node[anchor=north west, text width=7.7cm, align=left,
        font=\fontsize{4.5}{5.5}\selectfont\bfseries, text=rumelclr!65!black]
    at (3.05,-7.51) {Judea Pearl};
  \node[fill=millenniumclr, rounded corners=3pt, text width=2.8cm, minimum height=0.55cm,
        inner sep=0pt, align=center, anchor=north west] at (0,-7.86)
    {\fontsize{4.5}{5.5}\selectfont\bfseries\color{white}$\blacklozenge$\;\; 千禧\;\; 1人};
  \node[anchor=north west, text width=7.7cm, align=left,
        font=\fontsize{4.5}{5.5}\selectfont\bfseries, text=millenniumclr!65!black]
    at (3.05,-8.06) {Tim Berners-Lee};
  \node[fill=govclr, rounded corners=3pt, text width=2.8cm, minimum height=0.55cm,
        inner sep=0pt, align=center, anchor=north west] at (0,-8.41)
    {\fontsize{4.5}{5.5}\selectfont\bfseries\color{white}$\blacklozenge$\;\; 加拿大总督\;\; 1人};
  \node[anchor=north west, text width=7.7cm, align=left,
        font=\fontsize{4.5}{5.5}\selectfont\bfseries, text=govclr!65!black]
    at (3.05,-8.61) {Yoshua Bengio};
  \node[fill=abelclr, rounded corners=3pt, text width=2.8cm, minimum height=0.55cm,
        inner sep=0pt, align=center, anchor=north west] at (0,-8.96)
    {\fontsize{4.5}{5.5}\selectfont\bfseries\color{white}$\bigstar$\;\; 阿贝尔\;\; 1人};
  \node[anchor=north west, text width=7.7cm, align=left,
        font=\fontsize{4.5}{5.5}\selectfont\bfseries, text=abelclr!65!black]
    at (3.05,-9.16) {Avi Wigderson};
  \fill[turingbg, rounded corners=4pt] (0,-10.26) rectangle (\textwidth,-11.06);
  \node[anchor=north, font=\fontsize{5.5}{7}\selectfont\bfseries, text=turingclr]
    at (0.17\textwidth,-10.41) {首届\;\; Alan J. Perlis\;(1966)};
  \node[anchor=north, font=\fontsize{5.5}{7}\selectfont\bfseries, text=turingclr]
    at (0.50\textwidth,-10.41) {60 届\;\; 81 位得主};
  \node[anchor=north, font=\fontsize{5.5}{7}\selectfont\bfseries, text=turingclr]
    at (0.83\textwidth,-10.41) {图灵+诺贝尔\;\; Simon\;·\;Hinton};
\end{tikzpicture}
\end{frame}
