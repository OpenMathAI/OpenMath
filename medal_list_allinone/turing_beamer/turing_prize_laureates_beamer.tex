...
\midrule
  \lrow{Alan J. Perlis\cn{艾伦·佩利斯}}{1966}{1922–1990}{美国}{Carnegie Mellon University}{首届得主，Algol 语言与编译技术先驱。}
  \lrow{Maurice Wilkes\cn{莫里斯·威尔克斯}}{1967}{1913–2010}{英国}{University of Cambridge}{EDSAC 存储程序计算机、微程序设计。}
  \lrow{Richard Hamming\shannonbadge\cn{理查德·汉明}}{1968}{1915–1998}{美国}{Bell Labs}{数值方法、纠错码（汉明码），信息论先驱。}
  \lrow{Marvin Minsky\japanbadge\nsmbadge\cn{马文·明斯基}}{1969}{1927–2016}{美国}{MIT}{人工智能奠基人，框架理论、神经网络早期研究。}
  \lrow{James H. Wilkinson\cn{詹姆斯·威尔金森}}{1970}{1919–1986}{英国}{National Physical Laboratory}{数值分析、舍入误差分析，线性代数数值算法。}
\bottomrule
\end{tabular}
\vspace{6pt}
  {\centering
...
\textbf{姓名} & \textbf{年份} & \textbf{生卒} & \textbf{国籍} & \textbf{机构} & \textbf{研究领域} \\
\midrule
  \lrow{John McCarthy\kyotobadge\nsmbadge\cn{约翰·麦卡锡}}{1971}{1927–2011}{美国}{Stanford University}{AI 奠基人，提出「人工智能」一词，Lisp 之父。}
  \lrow{Edsger W. Dijkstra\cn{埃德加·迪杰斯特拉}}{1972}{1930–2002}{荷兰}{Eindhoven University of Technology}{结构化编程、Dijkstra 最短路径算法、并发原语。}
  \lrow{Charles Bachman\cn{查尔斯·巴赫曼}}{1973}{1924–2017}{美国}{—}{CODASYL 网状数据库模型，数据库系统奠基人。}
  \lrow{Donald Knuth\kyotobadge\nsmbadge\cn{唐纳德·高德纳}}{1974}{1938–}{美国}{Stanford University}{《计算机程序设计艺术》、算法分析、TeX 排版系统。}
  \lrow{Allen Newell\cn{艾伦·纽厄尔}}{1975}{1927–1992}{美国}{Carnegie Mellon University}{人工智能、认知科学，逻辑理论机。}
\bottomrule
\end{tabular}
\vspace{6pt}
  {\centering
...
\textbf{姓名} & \textbf{年份} & \textbf{生卒} & \textbf{国籍} & \textbf{机构} & \textbf{研究领域} \\
\midrule
  \lrow{Herbert A. Simon\nobelbadge\nsmbadge\cn{赫伯特·西蒙}}{1975}{1916–2001}{美国}{Carnegie Mellon University}{认知科学，另获诺贝尔经济学奖（1978）——图灵+诺奖双料。}
  ...
  \lrow{John Backus\nsmbadge\cn{约翰·巴克斯}}{1977}{1924–2007}{美国}{IBM}{Fortran 语言之父，BNF 文法描述编程语言语法。}
  \lrow{Robert W. Floyd\cn{罗伯特·弗洛伊德}}{1978}{1936–2001}{美国}{Stanford University}{程序设计方法学、Floyd 算法（判圈/最短路径）。}
\bottomrule
\end{tabular}
\vspace{6pt}
  {\centering
...
\textbf{姓名} & \textbf{年份} & \textbf{生卒} & \textbf{国籍} & \textbf{机构} & \textbf{研究领域} \\
\midrule
  \lrow{Kenneth E. Iverson\cn{肯尼思·艾弗森}}{1979}{1920–2004}{加拿大}{IBM}{APL 语言，交互式数组编程。}
  \lrow{Tony Hoare\kyotobadge\cn{托尼·霍尔}}{1980}{1934–}{英国}{University of Oxford}{快速排序、Hoare 逻辑（程序验证）、CSP 通信顺序进程。}
  \lrow{Edgar F. Codd\cn{埃德加·科德}}{1981}{1923–2003}{英国/美国}{IBM}{关系数据库模型，SQL 的理论根基。}
  \lrow{Stephen Cook\cn{史蒂芬·库克}}{1982}{1939–}{美国/加拿大}{University of Toronto}{P 与 NP 问题、Cook-Levin 定理，计算复杂性理论奠基人之一。}
  \lrow{Dennis Ritchie\japanbadge\cn{丹尼斯·里奇}}{1983}{1941–2011}{美国}{Bell Labs}{C 语言设计者、Unix 共同作者。}
\bottomrule
\end{tabular}
\vspace{6pt}
  {\centering
...
\textbf{姓名} & \textbf{年份} & \textbf{生卒} & \textbf{国籍} & \textbf{机构} & \textbf{研究领域} \\
\midrule
  \lrow{Ken Thompson\japanbadge\neumannbadge\cn{肯·汤普森}}{1983}{1943–}{美国}{Bell Labs}{Unix 操作系统与 C 语言共同之父。}
...
\textbf{姓名} & \textbf{年份} & \textbf{生卒} & \textbf{国籍} & \textbf{机构} & \textbf{研究领域} \\
\midrule
  \lrow{John Cocke\cn{约翰·科克}}{1987}{1925–2002}{美国}{IBM}{RISC 架构、编译器优化，IBM 体系结构先驱。}
  ...
  \lrow{Fernando J. Corbató\cn{费尔南多·科巴托}}{1990}{1926–2019}{美国}{MIT}{分时系统 CTSS、Multics，操作系统奠基人。}
  \lrow{Robin Milner\cn{罗宾·米尔纳}}{1991}{1934–2010}{英国}{University of Edinburgh}{ML 语言、LCF 定理证明、$\pi$ 演算（并发理论）。}
\bottomrule
\end{tabular}
\vspace{6pt}
  {\centering
...
\midrule
  ...
  \lrow{Juris Hartmanis\cn{尤里斯·哈特马尼斯}}{1993}{1928–2022}{美国/拉脱维亚}{Cornell University}{计算复杂性分层定理，复杂性理论共同奠基人。}
...
\midrule
  ...
  \lrow{Amir Pnueli\cn{阿米尔·普努利}}{1996}{1941–2009}{以色列}{Weizmann Institute}{时态逻辑、程序验证，反应系统形式化。}
  \lrow{Douglas Engelbart\cn{道格拉斯·恩格尔巴特}}{1997}{1925–2013}{美国}{—}{鼠标发明者、超文本、图形交互（NLS）。}
  \lrow{Jim Gray\cn{吉姆·格雷}}{1998}{1944–2012}{美国}{Microsoft Research}{事务处理、数据库系统与在线分析处理。}
  \lrow{Fred Brooks\cn{弗雷德·布鲁克斯}}{1999}{1931–2022}{美国}{University of North Carolina}{OS/360 软件工程、《人月神话》作者。}
\bottomrule
\end{tabular}
\vspace{6pt}
  {\centering
...
\textbf{姓名} & \textbf{年份} & \textbf{生卒} & \textbf{国籍} & \textbf{机构} & \textbf{研究领域} \\
\midrule
  \lrow{Andrew Yao\kyotobadge\nsmbadge\cn{姚期智}}{2000}{1946–}{美国/中国}{Princeton University / Tsinghua}{通信复杂性、密码学、量子计算——首位华人图灵奖得主。}
  \lrow{Kristen Nygaard\cn{克里斯汀·尼加德}}{2001}{1926–2002}{挪威}{University of Oslo}{面向对象编程（Simula 语言），与 Dahl 同获 2001 年奖。}
  \lrow{Ole-Johan Dahl\cn{奥利-约翰·达尔}}{2001}{1931–2002}{挪威}{University of Oslo}{面向对象编程（Simula 语言），OOP 先驱。}
...
\midrule
  ...
  \lrow{Vint Cerf\japanbadge\marconibadge\nsmbadge\cn{文顿·瑟夫}}{2004}{1943–}{美国}{—}{TCP/IP 协议共同设计者，互联网之父之一。}
  \lrow{Peter Naur\cn{彼得·诺尔}}{2005}{1928–2016}{丹麦}{—}{Algol 60、BNF 文法、软件工程方法论。}
\bottomrule
\end{tabular}
\vspace{6pt}
  {\centering
...
\textbf{姓名} & \textbf{年份} & \textbf{生卒} & \textbf{国籍} & \textbf{机构} & \textbf{研究领域} \\
\midrule
  \lrow{Frances E. Allen\cn{弗朗西丝·艾伦}}{2006}{1932–2020}{美国}{IBM}{编译器优化、并行计算，首位女性图灵奖得主。}
  \lrow{E. Allen Emerson\cn{艾伦·埃默森}}{2007}{1954–}{美国}{University of Texas at Austin}{模型检验、时态逻辑。}
  \lrow{Edmund M. Clarke\cn{埃德蒙·克拉克}}{2007}{1945–2020}{美国}{Carnegie Mellon University}{模型检验（Model Checking）奠基人。}
  \lrow{Joseph Sifakis\cn{约瑟夫·西法基斯}}{2007}{1946–}{法国/希腊}{Verimag}{模型检验、并发系统验证。}
  \lrow{Barbara Liskov\nsmbadge\cn{芭芭拉·利斯科夫}}{2008}{1939–}{美国}{MIT}{分布式系统、数据抽象、Liskov 替换原则，第二位女性得主。}
\bottomrule
\end{tabular}
\vspace{6pt}
  {\centering
...
\textbf{姓名} & \textbf{年份} & \textbf{生卒} & \textbf{国籍} & \textbf{机构} & \textbf{研究领域} \\
\midrule
  \lrow{Charles P. Thacker\cn{查尔斯·萨克}}{2009}{1943–2017}{美国}{Microsoft Research}{Alto 个人电脑、以太网、平板显示。}
...
\textbf{姓名} & \textbf{年份} & \textbf{生卒} & \textbf{国籍} & \textbf{机构} & \textbf{研究领域} \\
\midrule
  \lrow{Leslie Lamport\neumannbadge\nsmbadge\cn{莱斯利·兰波特}}{2013}{1941–}{美国}{Microsoft Research}{Paxos 共识算法、时序逻辑、LaTeX。}
  \lrow{Michael Stonebraker\cn{迈克尔·斯通布雷克}}{2014}{1943–}{美国}{MIT}{Ingres、PostgreSQL 数据库系统，流处理先驱。}
  \lrow{Martin Hellman\shannonbadge\marconibadge\cn{马丁·赫尔曼}}{2015}{1945–}{美国}{Stanford University}{公钥密码学（Diffie-Hellman 密钥交换）。}
  \lrow{Whitfield Diffie\shannonbadge\marconibadge\cn{惠特菲尔德·迪菲}}{2015}{1944–}{美国}{—}{公钥密码学（Diffie-Hellman 密钥交换）。}
  \lrow{Tim Berners-Lee\millenniumbadge\frsbadge\cn{蒂姆·伯纳斯-李}}{2016}{1955–}{英国}{W3C / MIT}{万维网（WWW）发明者，HTML、HTTP、URL。}
\bottomrule
\end{tabular}
\vspace{6pt}
  {\centering
...
\midrule
  ...
  \lrow{Geoffrey Hinton\nobelbadge\japanbadge\frsbadge\cn{杰弗里·辛顿}}{2018}{1947–}{英国/加拿大}{University of Toronto}{深度学习三杰之一，反向传播、神经网络复兴。}
  \lrow{Yann LeCun\nsmbadge\frsbadge\cn{杨立昆}}{2018}{1960–}{法国/美国}{New York University}{深度学习三杰之一，卷积神经网络（CNN）之父。}
  \lrow{Yoshua Bengio\frsbadge\govbadge\cn{约书亚·本吉奥}}{2018}{1964–}{加拿大/法国}{Université de Montréal}{深度学习三杰之一，表示学习与生成模型。}
\bottomrule
\end{tabular}
\vspace{6pt}
  {\centering
...
\midrule
  ...
  \lrow{Jack Dongarra\nsmbadge\cn{杰克·唐加拉}}{2021}{1950–}{美国}{University of Tennessee}{LINPACK/LAPACK、MPI，高性能计算奠基人。}
\bottomrule
\end{tabular}
\vspace{6pt}
  {\centering
...
\textbf{姓名} & \textbf{年份} & \textbf{生卒} & \textbf{国籍} & \textbf{机构} & \textbf{研究领域} \\
\midrule
  \lrow{Robert Metcalfe\nsmbadge\cn{罗伯特·梅特卡夫}}{2022}{1946–}{美国}{MIT}{以太网（Ethernet）发明者，梅特卡夫定律。}
...
\textbf{姓名} & \textbf{年份} & \textbf{生卒} & \textbf{国籍} & \textbf{机构} & \textbf{研究领域} \\
\midrule
  \lrow{Gilles Brassard\wolfbadge\cn{吉勒·布拉萨}}{2025}{1955–}{加拿大}{Université de Montréal}{量子密码学、BB84 协议、量子纠缠理论。}
\bottomrule
\end{tabular}
\vspace{6pt}
  {\centering
...
\def\framesubject{诺贝尔·沃尔夫·京都·哥德尔·阿贝尔·香农等交叉得主}
\begin{frame}{交叉奖项总览}
\vspace{-4pt}
\centering
\begin{tikzpicture}
  \node[fill=nsmclr, rounded corners=3pt, text width=2.8cm, minimum height=0.55cm,
        inner sep=0pt, align=center, anchor=north west] at (0,0.00)
    {\fontsize{6}{8}\selectfont\bfseries\color{white}$\spadesuit$\;\; 国家科学奖章\;\; 15人};
  \node[anchor=north west, font=\fontsize{6}{8}\selectfont\bfseries, text=nsmclr!65!black]
    at (3.05,-0.22) {Marvin Minsky\;·\;John McCarthy\;·\;Donald Knuth\;·\;Herbert A. Simon\;·\;John Backus\;·\;Richard Karp\;·\;William Kahan\;·\;Andrew Yao\;·\;Vint Cerf\;·\;Barbara Liskov\;·\;Judea Pearl\;·\;Leslie Lamport\;·\;Yann LeCun\;·\;Jack Dongarra\;·\;Robert Metcalfe};
  \node[fill=kyotoclr, rounded corners=3pt, text width=2.8cm, minimum height=0.55cm,
        inner sep=0pt, align=center, anchor=north west] at (0,-0.75)
    {\fontsize{6}{8}\selectfont\bfseries\color{white}$\blacklozenge$\;\; 京都\;\; 7人};
  \node[anchor=north west, font=\fontsize{6}{8}\selectfont\bfseries, text=kyotoclr!65!black]
    at (3.05,-0.97) {John McCarthy\;·\;Donald Knuth\;·\;Tony Hoare\;·\;Richard Karp\;·\;Ivan Sutherland\;·\;Andrew Yao\;·\;Alan Kay};
  \node[fill=japanclr, rounded corners=3pt, text width=2.8cm, minimum height=0.55cm,
        inner sep=0pt, align=center, anchor=north west] at (0,-1.50)
    {\fontsize{6}{8}\selectfont\bfseries\color{white}$\heartsuit$\;\; 日本国际\;\; 5人};
  \node[anchor=north west, font=\fontsize{6}{8}\selectfont\bfseries, text=japanclr!65!black]
    at (3.05,-1.72) {Marvin Minsky\;·\;Dennis Ritchie\;·\;Ken Thompson\;·\;Vint Cerf\;·\;Geoffrey Hinton};
  \node[fill=frsclr, rounded corners=3pt, text width=2.8cm, minimum height=0.55cm,
        inner sep=0pt, align=center, anchor=north west] at (0,-2.25)
    {\fontsize{6}{8}\selectfont\bfseries\color{white}$\checkmark$\;\; 皇家学会院士\;\; 5人};
  \node[anchor=north west, font=\fontsize{6}{8}\selectfont\bfseries, text=frsclr!65!black]
    at (3.05,-2.47) {Adi Shamir\;·\;Tim Berners-Lee\;·\;Geoffrey Hinton\;·\;Yann LeCun\;·\;Yoshua Bengio};
  \node[fill=shannonclr, rounded corners=3pt, text width=2.8cm, minimum height=0.55cm,
        inner sep=0pt, align=center, anchor=north west] at (0,-3.00)
    {\fontsize{6}{8}\selectfont\bfseries\color{white}$\bigstar$\;\; 香农\;\; 4人};
  \node[anchor=north west, font=\fontsize{6}{8}\selectfont\bfseries, text=shannonclr!65!black]
    at (3.05,-3.22) {Richard Hamming\;·\;Martin Hellman\;·\;Whitfield Diffie\;·\;Charles H. Bennett};
  \node[fill=marconiclr, rounded corners=3pt, text width=2.8cm, minimum height=0.55cm,
        inner sep=0pt, align=center, anchor=north west] at (0,-3.75)
    {\fontsize{6}{8}\selectfont\bfseries\color{white}$\bullet$\;\; 马可尼\;\; 4人};
  \node[anchor=north west, font=\fontsize{6}{8}\selectfont\bfseries, text=marconiclr!65!black]
    at (3.05,-3.97) {Ronald Rivest\;·\;Vint Cerf\;·\;Martin Hellman\;·\;Whitfield Diffie};
  \node[fill=neumannclr, rounded corners=3pt, text width=2.8cm, minimum height=0.55cm,
        inner sep=0pt, align=center, anchor=north west] at (0,-4.50)
    {\fontsize{6}{8}\selectfont\bfseries\color{white}$\blacktriangle$\;\; 冯\;\; 3人};
  \node[anchor=north west, font=\fontsize{6}{8}\selectfont\bfseries, text=neumannclr!65!black]
    at (3.05,-4.72) {Ken Thompson\;·\;Ivan Sutherland\;·\;Leslie Lamport};
  \node[fill=wolfclr, rounded corners=3pt, text width=2.8cm, minimum height=0.55cm,
        inner sep=0pt, align=center, anchor=north west] at (0,-5.25)
    {\fontsize{6}{8}\selectfont\bfseries\color{white}$\bigstar$\;\; 沃尔夫\;\; 3人};
  \node[anchor=north west, font=\fontsize{6}{8}\selectfont\bfseries, text=wolfclr!65!black]
    at (3.05,-5.47) {Adi Shamir\;·\;Charles H. Bennett\;·\;Gilles Brassard};
  \node[fill=godelclr, rounded corners=3pt, text width=2.8cm, minimum height=0.55cm,
        inner sep=0pt, align=center, anchor=north west] at (0,-6.00)
    {\fontsize{6}{8}\selectfont\bfseries\color{white}$\diamond$\;\; 哥德尔\;\; 3人};
  \node[anchor=north west, font=\fontsize{6}{8}\selectfont\bfseries, text=godelclr!65!black]
    at (3.05,-6.22) {Shafi Goldwasser\;·\;Silvio Micali\;·\;Avi Wigderson};
  \node[fill=nobelclr, rounded corners=3pt, text width=2.8cm, minimum height=0.55cm,
        inner sep=0pt, align=center, anchor=north west] at (0,-6.75)
    {\fontsize{6}{8}\selectfont\bfseries\color{white}\faIcon{award}\;\; 诺贝尔\;\; 2人};
  \node[anchor=north west, font=\fontsize{6}{8}\selectfont\bfseries, text=nobelclr!65!black]
    at (3.05,-6.97) {Herbert A. Simon\;·\;Geoffrey Hinton};
  \node[fill=eatcsclr, rounded corners=3pt, text width=2.8cm, minimum height=0.55cm,
        inner sep=0pt, align=center, anchor=north west] at (0,-7.50)
    {\fontsize{6}{8}\selectfont\bfseries\color{white}$\square$\;\; EATCS\;\; 2人};
  \node[anchor=north west, font=\fontsize{6}{8}\selectfont\bfseries, text=eatcsclr!65!black]
    at (3.05,-7.72) {Richard Karp\;·\;Leslie Valiant};
  \node[fill=nevanclr, rounded corners=3pt, text width=2.8cm, minimum height=0.55cm,
        inner sep=0pt, align=center, anchor=north west] at (0,-8.25)
    {\fontsize{6}{8}\selectfont\bfseries\color{white}$\blacktriangle$\;\; 内万林纳\;\; 2人};
  \node[anchor=north west, font=\fontsize{6}{8}\selectfont\bfseries, text=nevanclr!65!black]
    at (3.05,-8.47) {Leslie Valiant\;·\;Avi Wigderson};
  \node[fill=nasclr, rounded corners=3pt, text width=2.8cm, minimum height=0.55cm,
        inner sep=0pt, align=center, anchor=north west] at (0,-9.00)
    {\fontsize{6}{8}\selectfont\bfseries\color{white}$\blacksquare$\;\; 科学院院士\;\; 2人};
  \node[anchor=north west, font=\fontsize{6}{8}\selectfont\bfseries, text=nasclr!65!black]
    at (3.05,-9.22) {Shafi Goldwasser\;·\;Silvio Micali};
  \node[fill=rumelclr, rounded corners=3pt, text width=2.8cm, minimum height=0.55cm,
        inner sep=0pt, align=center, anchor=north west] at (0,-9.75)
    {\fontsize{6}{8}\selectfont\bfseries\color{white}$\diamondsuit$\;\; 鲁梅哈特\;\; 1人};
  \node[anchor=north west, font=\fontsize{6}{8}\selectfont\bfseries, text=rumelclr!65!black]
    at (3.05,-9.97) {Judea Pearl};
  \node[fill=millenniumclr, rounded corners=3pt, text width=2.8cm, minimum height=0.55cm,
        inner sep=0pt, align=center, anchor=north west] at (0,-10.50)
    {\fontsize{6}{8}\selectfont\bfseries\color{white}$\blacklozenge$\;\; 千禧\;\; 1人};
  \node[anchor=north west, font=\fontsize{6}{8}\selectfont\bfseries, text=millenniumclr!65!black]
    at (3.05,-10.72) {Tim Berners-Lee};
  \node[fill=govclr, rounded corners=3pt, text width=2.8cm, minimum height=0.55cm,
        inner sep=0pt, align=center, anchor=north west] at (0,-11.25)
    {\fontsize{6}{8}\selectfont\bfseries\color{white}$\blacklozenge$\;\; 加拿大总督\;\; 1人};
  \node[anchor=north west, font=\fontsize{6}{8}\selectfont\bfseries, text=govclr!65!black]
    at (3.05,-11.47) {Yoshua Bengio};
  \node[fill=abelclr, rounded corners=3pt, text width=2.8cm, minimum height=0.55cm,
        inner sep=0pt, align=center, anchor=north west] at (0,-12.00)
    {\fontsize{6}{8}\selectfont\bfseries\color{white}$\bigstar$\;\; 阿贝尔\;\; 1人};
  \node[anchor=north west, font=\fontsize{6}{8}\selectfont\bfseries, text=abelclr!65!black]
    at (3.05,-12.22) {Avi Wigderson};
  \fill[turingbg, rounded corners=4pt] (0,-13.50) rectangle (\textwidth,-14.30);
  \node[anchor=north, font=\fontsize{5.5}{7}\selectfont\bfseries, text=turingclr]
    at (0.17\textwidth,-13.65) {首届\;\; Alan J. Perlis\;(1966)};
  \node[anchor=north, font=\fontsize{5.5}{7}\selectfont\bfseries, text=turingclr]
    at (0.50\textwidth,-13.65) {60 届\;\; 81 位得主};
  \node[anchor=north, font=\fontsize{5.5}{7}\selectfont\bfseries, text=turingclr]
    at (0.83\textwidth,-13.65) {图灵+诺贝尔\;\; Simon\;·\;Hinton};
\end{tikzpicture}
\end{frame}
