...
\centering
\begin{tikzpicture}
  \node[fill=nsmclr, rounded corners=4pt, text width=3.6cm, minimum height=0.55cm,
        inner sep=0pt, align=center, anchor=north west] at (-5.70,0.00)
    {\fontsize{5}{6}\selectfont\bfseries\color{white}$\spadesuit$\;\; 美国国家科学奖章\;\; 15人};
  \node[anchor=north west, text width=4.0cm, align=left,
        font=\fontsize{5}{6}\selectfont, text=nsmclr!70!black]
    at (-1.95,0.00) {Marvin Minsky\;·\;John McCarthy\;·\;Donald Knuth\;·\;Herbert A. Simon \\ John Backus\;·\;Richard Karp\;·\;William Kahan\;·\;Andrew Yao \\ Vint Cerf\;·\;Barbara Liskov\;·\;Judea Pearl\;·\;Leslie Lamport \\ Yann LeCun\;·\;Jack Dongarra\;·\;Robert Metcalfe};
  \node[fill=kyotoclr, rounded corners=4pt, text width=3.6cm, minimum height=0.55cm,
        inner sep=0pt, align=center, anchor=north west] at (-5.70,-1.04)
    {\fontsize{5}{6}\selectfont\bfseries\color{white}$\blacklozenge$\;\; 京都奖\;\; 7人};
  \node[anchor=north west, text width=4.0cm, align=left,
        font=\fontsize{5}{6}\selectfont, text=kyotoclr!70!black]
    at (-1.95,-1.04) {John McCarthy\;·\;Donald Knuth\;·\;Tony Hoare\;·\;Richard Karp \\ Ivan Sutherland\;·\;Andrew Yao\;·\;Alan Kay};
  \node[fill=japanclr, rounded corners=4pt, text width=3.6cm, minimum height=0.55cm,
        inner sep=0pt, align=center, anchor=north west] at (-5.70,-1.60)
    {\fontsize{5}{6}\selectfont\bfseries\color{white}$\heartsuit$\;\; 日本国际奖\;\; 5人};
  \node[anchor=north west, text width=4.0cm, align=left,
        font=\fontsize{5}{6}\selectfont, text=japanclr!70!black]
    at (-1.95,-1.60) {Marvin Minsky\;·\;Dennis Ritchie\;·\;Ken Thompson\;·\;Vint Cerf \\ Geoffrey Hinton};
  \node[fill=frsclr, rounded corners=4pt, text width=3.6cm, minimum height=0.55cm,
        inner sep=0pt, align=center, anchor=north west] at (-5.70,-2.16)
    {\fontsize{5}{6}\selectfont\bfseries\color{white}$\checkmark$\;\; 英国皇家学会院士\;\; 5人};
  \node[anchor=north west, text width=4.0cm, align=left,
        font=\fontsize{5}{6}\selectfont, text=frsclr!70!black]
    at (-1.95,-2.16) {Adi Shamir\;·\;Tim Berners-Lee\;·\;Geoffrey Hinton\;·\;Yann LeCun \\ Yoshua Bengio};
  \node[fill=shannonclr, rounded corners=4pt, text width=3.6cm, minimum height=0.55cm,
        inner sep=0pt, align=center, anchor=north west] at (-5.70,-2.72)
    {\fontsize{5}{6}\selectfont\bfseries\color{white}$\bigstar$\;\; IEEE 香农奖\;\; 4人};
  \node[anchor=north west, text width=4.0cm, align=left,
        font=\fontsize{5}{6}\selectfont, text=shannonclr!70!black]
    at (-1.95,-2.72) {Richard Hamming\;·\;Martin Hellman\;·\;Whitfield Diffie\;·\;Charles H. Bennett};
  \node[fill=marconiclr, rounded corners=4pt, text width=3.6cm, minimum height=0.55cm,
        inner sep=0pt, align=center, anchor=north west] at (-5.70,-3.27)
    {\fontsize{5}{6}\selectfont\bfseries\color{white}$\bullet$\;\; 马可尼奖\;\; 4人};
  \node[anchor=north west, text width=4.0cm, align=left,
        font=\fontsize{5}{6}\selectfont, text=marconiclr!70!black]
    at (-1.95,-3.27) {Ronald Rivest\;·\;Vint Cerf\;·\;Martin Hellman\;·\;Whitfield Diffie};
  \node[fill=neumannclr, rounded corners=4pt, text width=3.6cm, minimum height=0.55cm,
        inner sep=0pt, align=center, anchor=north west] at (-5.70,-3.82)
    {\fontsize{5}{6}\selectfont\bfseries\color{white}$\blacktriangle$\;\; IEEE 冯·诺依曼奖\;\; 3人};
  \node[anchor=north west, text width=4.0cm, align=left,
        font=\fontsize{5}{6}\selectfont, text=neumannclr!70!black]
    at (-1.95,-3.82) {Ken Thompson\;·\;Ivan Sutherland\;·\;Leslie Lamport};
  \node[fill=wolfclr, rounded corners=4pt, text width=3.6cm, minimum height=0.55cm,
        inner sep=0pt, align=center, anchor=north west] at (-5.70,-4.37)
    {\fontsize{5}{6}\selectfont\bfseries\color{white}$\bigstar$\;\; 沃尔夫奖\;\; 3人};
  \node[anchor=north west, text width=4.0cm, align=left,
        font=\fontsize{5}{6}\selectfont, text=wolfclr!70!black]
    at (-1.95,-4.37) {Adi Shamir\;·\;Charles H. Bennett\;·\;Gilles Brassard};
  \node[fill=godelclr, rounded corners=4pt, text width=3.6cm, minimum height=0.55cm,
        inner sep=0pt, align=center, anchor=north west] at (-5.70,-4.92)
    {\fontsize{5}{6}\selectfont\bfseries\color{white}$\diamond$\;\; 哥德尔奖\;\; 3人};
  \node[anchor=north west, text width=4.0cm, align=left,
        font=\fontsize{5}{6}\selectfont, text=godelclr!70!black]
    at (-1.95,-4.92) {Shafi Goldwasser\;·\;Silvio Micali\;·\;Avi Wigderson};
  \node[fill=nobelclr, rounded corners=4pt, text width=3.6cm, minimum height=0.55cm,
        inner sep=0pt, align=center, anchor=north west] at (0.80,0.00)
    {\fontsize{5}{6}\selectfont\bfseries\color{white}\faIcon{award}\;\; 诺贝尔奖\;\; 2人};
  \node[anchor=north west, text width=4.0cm, align=left,
        font=\fontsize{5}{6}\selectfont, text=nobelclr!70!black]
    at (4.55,0.00) {Herbert A. Simon\;·\;Geoffrey Hinton};
  \node[fill=eatcsclr, rounded corners=4pt, text width=3.6cm, minimum height=0.55cm,
        inner sep=0pt, align=center, anchor=north west] at (0.80,-0.55)
    {\fontsize{5}{6}\selectfont\bfseries\color{white}$\square$\;\; EATCS 奖\;\; 2人};
  \node[anchor=north west, text width=4.0cm, align=left,
        font=\fontsize{5}{6}\selectfont, text=eatcsclr!70!black]
    at (4.55,-0.55) {Richard Karp\;·\;Leslie Valiant};
  \node[fill=nevanclr, rounded corners=4pt, text width=3.6cm, minimum height=0.55cm,
        inner sep=0pt, align=center, anchor=north west] at (0.80,-1.10)
    {\fontsize{5}{6}\selectfont\bfseries\color{white}$\blacktriangle$\;\; 内万林纳奖\;\; 2人};
  \node[anchor=north west, text width=4.0cm, align=left,
        font=\fontsize{5}{6}\selectfont, text=nevanclr!70!black]
    at (4.55,-1.10) {Leslie Valiant\;·\;Avi Wigderson};
  \node[fill=nasclr, rounded corners=4pt, text width=3.6cm, minimum height=0.55cm,
        inner sep=0pt, align=center, anchor=north west] at (0.80,-1.65)
    {\fontsize{5}{6}\selectfont\bfseries\color{white}$\blacksquare$\;\; 美国科学院院士\;\; 2人};
  \node[anchor=north west, text width=4.0cm, align=left,
        font=\fontsize{5}{6}\selectfont, text=nasclr!70!black]
    at (4.55,-1.65) {Shafi Goldwasser\;·\;Silvio Micali};
  \node[fill=rumelclr, rounded corners=4pt, text width=3.6cm, minimum height=0.55cm,
        inner sep=0pt, align=center, anchor=north west] at (0.80,-2.20)
    {\fontsize{5}{6}\selectfont\bfseries\color{white}$\diamondsuit$\;\; 鲁梅哈特奖\;\; 1人};
  \node[anchor=north west, text width=4.0cm, align=left,
        font=\fontsize{5}{6}\selectfont, text=rumelclr!70!black]
    at (4.55,-2.20) {Judea Pearl};
  \node[fill=millenniumclr, rounded corners=4pt, text width=3.6cm, minimum height=0.55cm,
        inner sep=0pt, align=center, anchor=north west] at (0.80,-2.75)
    {\fontsize{5}{6}\selectfont\bfseries\color{white}$\blacklozenge$\;\; 千禧科技奖\;\; 1人};
  \node[anchor=north west, text width=4.0cm, align=left,
        font=\fontsize{5}{6}\selectfont, text=millenniumclr!70!black]
    at (4.55,-2.75) {Tim Berners-Lee};
  \node[fill=govclr, rounded corners=4pt, text width=3.6cm, minimum height=0.55cm,
        inner sep=0pt, align=center, anchor=north west] at (0.80,-3.30)
    {\fontsize{5}{6}\selectfont\bfseries\color{white}$\blacklozenge$\;\; 加拿大总督奖\;\; 1人};
  \node[anchor=north west, text width=4.0cm, align=left,
        font=\fontsize{5}{6}\selectfont, text=govclr!70!black]
    at (4.55,-3.30) {Yoshua Bengio};
  \node[fill=abelclr, rounded corners=4pt, text width=3.6cm, minimum height=0.55cm,
        inner sep=0pt, align=center, anchor=north west] at (0.80,-3.85)
    {\fontsize{5}{6}\selectfont\bfseries\color{white}$\bigstar$\;\; 阿贝尔奖\;\; 1人};
  \node[anchor=north west, text width=4.0cm, align=left,
        font=\fontsize{5}{6}\selectfont, text=abelclr!70!black]
    at (4.55,-3.85) {Avi Wigderson};
  \fill[turingbg, rounded corners=4pt] (-5.7,-6.37) rectangle (8.4,-5.87);
  \node[anchor=north, font=\fontsize{5.5}{7}\selectfont\bfseries, text=turingclr]
    at (-3.8,-5.97) {首届\;\; Alan J. Perlis\;(1966)};
  \node[anchor=north, font=\fontsize{5.5}{7}\selectfont\bfseries, text=turingclr]
    at (0.0,-5.97) {60 届\;\; 81 位得主};
  \node[anchor=north, font=\fontsize{5.5}{7}\selectfont\bfseries, text=turingclr]
    at (3.8,-5.97) {图灵+诺奖\;\; Simon\;·\;Hinton};
\end{tikzpicture}
\end{frame}
