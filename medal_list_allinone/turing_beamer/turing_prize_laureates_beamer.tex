...
\def\framesubject{诺贝尔·沃尔夫·京都·哥德尔·阿贝尔·香农等交叉得主（I · 顶级交叉）}
\begin{frame}{交叉奖项总览}
\vspace{-4pt}
\centering
\begin{tikzpicture}
  ...
  \node[anchor=north, font=\fontsize{5.5}{7}\selectfont\bfseries, text=turingclr]
    at (-3.6,-5.11) {首届\;\; Alan J. Perlis\;(1966)};
  \node[anchor=north, font=\fontsize{5.5}{7}\selectfont\bfseries, text=turingclr]
    at (0.0,-5.11) {60 届\;\; 81 位得主};
  \node[anchor=north, font=\fontsize{5.5}{7}\selectfont\bfseries, text=turingclr]
    at (3.6,-5.11) {图灵+诺奖\;\; Simon\;·\;Hinton};
\end{tikzpicture}
\end{frame}

\def\framesubject{（II · 其他重要荣誉）}
\begin{frame}{交叉奖项总览}
\vspace{-4pt}
\centering
\begin{tikzpicture}
  ...
  \node[anchor=north, font=\fontsize{5.5}{7}\selectfont\bfseries, text=turingclr]
    at (-3.6,-5.45) {首届\;\; Alan J. Perlis\;(1966)};
  \node[anchor=north, font=\fontsize{5.5}{7}\selectfont\bfseries, text=turingclr]
    at (0.0,-5.45) {60 届\;\; 81 位得主};
  \node[anchor=north, font=\fontsize{5.5}{7}\selectfont\bfseries, text=turingclr]
    at (3.6,-5.45) {图灵+诺奖\;\; Simon\;·\;Hinton};
\end{tikzpicture}
\end{frame}
