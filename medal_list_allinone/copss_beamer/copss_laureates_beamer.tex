...
\begin{tikzpicture}
  ...
  \node[anchor=north west, text width=8.0cm, align=left,
        font=\fontsize{5.5}{6.5}\selectfont, text=wolfclr!70!black]
    at (-1.70,-0.55) {Hall\;(2011)\;·\;McCullagh\;(金2026)\;·\;Silverman\;·\;Johnstone\;(银2010)\;·\;Fan\;(银2014)};
  \node[fill=fieldsclr, rounded corners=4pt, text width=3.5cm, minimum height=0.55cm,
        inner sep=0pt, align=center, anchor=north west] at (-5.4,-1.10)
    {\fontsize{5.5}{6.5}\selectfont\bfseries\color{white}$\blacklozenge$\;\; MacArthur 天才奖\;\; 2人};
  \node[anchor=north west, text width=8.0cm, align=left,
        font=\fontsize{5.5}{6.5}\selectfont, text=fieldsclr!70!black]
    at (-1.70,-1.10) {Peter J. Bickel\;(1984)\;·\;Rina Foygel Barber\;(2024)};
  ...
  \node[anchor=north west, text width=8.0cm, align=left,
        font=\fontsize{5.5}{6.5}\selectfont, text=copssclr!70!black]
    at (-1.70,-1.65) {Hall\;·\;Silverman\;·\;McCullagh\;·\;Wong\;(统计学界的国际学术认可)};
  \fill[copssbg, rounded corners=4pt] (-5.5,-4.30) rectangle (5.6,-3.80);
  \node[anchor=north, text width=3.7cm, align=center,
               font=\fontsize{4.5}{5.5}\selectfont\bfseries, text=copssclr]
    at (-3.60,-3.90) {统计双冠王\;\; Fisher+Guy\;\; Hall};
  \node[anchor=north, text width=3.7cm, align=center,
               font=\fontsize{4.5}{5.5}\selectfont\bfseries, text=copssclr]
    at (0.00,-3.90) {学科高峰\;\; 从 Bickel 到 Su\;\; 1981–2026};
  \node[anchor=north, text width=3.7cm, align=center,
               font=\fontsize{4.5}{5.5}\selectfont\bfseries, text=copssclr]
    at (3.60,-3.90) {统计是数据时代的语言};
\end{tikzpicture}
\end{frame}
