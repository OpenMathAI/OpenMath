...
> 本提示词严格遵循 [Mathematician_Biography_Guide.md](./Mathematician_Biography_Guide.md)，以 Grothendieck 和 Riemann 成品为参考模板，为希尔伯特制作 Beamer 演示文稿。
> 直接复制本文件内容到新对话中使用。
...
> **字段总纲**：数据库全部字段（职业/领域/奖项/机构/国籍/排行榜）的梳理规范见工作指南 **§二十一**；补全时使用 §21.5 内嵌核对表逐项填值并写入库脚本。
...
=== 结尾 ===
18  思想回响 — Hilbert 不只是一个人，他是一个时代的标志
19  结束页
```
