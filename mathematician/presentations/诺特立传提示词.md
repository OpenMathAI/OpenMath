...
- 输出以下信息供我校验：
  ...
  - **重要合作者/学生**：
    ...
    - "诺特男孩"（Noether's boys）：van der Waerden, Hasse, Deuring, Mac Lane, Alexandroff 等
...
3. **从计算到抽象** — 她的博士论文（在 Gordan 指导下）充满了冗长的多项式计算。但转入抽象方法后，她说："计算？我不懂计算。" 这种风格转变是 20 世纪数学"抽象转向"的缩影
...
08  诺特男孩 — van der Waerden, Hasse, Mac Lane…… 一代代数大家的共同母亲
