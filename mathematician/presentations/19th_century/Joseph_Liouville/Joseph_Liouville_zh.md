...
5. **伽罗瓦工作的第一位真正发掘者、整理者、出版人（★ 本传核心叙事，必须突出）**：伽罗瓦（1811–1832）20 岁早逝，其深刻工作生前屡遭误解与冷遇——Cauchy 曾搁置其论文、Fourier 收到后未及评审即去世、Poisson 评为"难以理解"。伽罗瓦临终前将手稿托付给好友 Auguste Chevalier。刘维尔**最早真正读懂伽罗瓦工作的价值**（"one of the first to grasp the significance"），并投入数年系统整理，于 1846 年在自己创办的《纯数学与应用数学杂志》上**首次完整编辑出版**伽罗瓦的著作，使伽罗瓦理论（群论）广为人知，间接推动了现代代数与群论的发展。这份"发掘—整理—出版"之功，让一位早逝天才的思想得以传世。
...
1. **封面**（`\titleslide`）：大标题「超越数的证明者 · 伽罗瓦工作的发掘者」+ 刘维尔 1809–1882 + 右上头像 + 国籍行 + 底部三要素状态栏 + 分类 badge
2. **身份信息页**（`\profileslide`，★ 必做）：左头像 + 右信息网格（生卒 / 本名 / 国籍 / 出生地 / 师承 / 教育 / 荣誉 / 核心领域）
3. **刘维尔的一生：时间线**（`\timelineslide`）：1809 出生 → 1825 综合理工 → 1836 创办杂志 → 1838 综合理工教授 → 1844 证明超越数 → 1846 出版伽罗瓦著作 → 1882 去世
4. **早年与教育**（1809–1836，表格）：Saint-Omer、École Polytechnique、桥梁道路学校、1836 博士
5. **超越数的证明**（核心贡献页，表格 + 刘维尔数公式框）：1844 第一个证明超越数存在、判据
6. **刘维尔定理（复分析）**（核心贡献页，表格 + 公式框）：有界整函数为常数
7. **Sturm–Liouville 理论**（核心贡献页，表格 + 公式框）：与 Sturm 合作、推广傅里叶分析
8. **刘维尔定理（哈密顿力学）与相空间**（核心贡献页，表格 + 公式框）：相空间体积守恒、统计力学基础
9. **伽罗瓦工作的发掘与出版**（★ 核心叙事页，表格）：伽罗瓦早逝、Chevalier 转交、刘维尔第一位读懂并 1846 年首次完整出版、推动群论与现代代数
10. **创办杂志与学术生涯**（表格）：Journal de Mathématiques、政治参与（1848 制宪议会）
11. **Liouville–Green 方法与其他贡献**（表格）：WKB 近似、分数阶微积分、刘维尔函数
12. **终章**：73 岁、从超越数到伽罗瓦出版的历史地位与遗产
...
- **出版伽罗瓦著作**：伽罗瓦早逝，其工作由好友 Auguste Chevalier 转交；Liouville 是**第一位真正发掘、整理并出版**伽罗瓦著作的人（1846 年首次完整编辑出版）——表述为"发掘者、整理者、出版人"，既非"发现"伽罗瓦理论（伽罗瓦本人已创立，只是生前未获认可），也勿贬低 Chevalier 的转交之功。
...
- **肖像**：`page.md` infobox 中有 1868 年肖像 `Photo_of_Joseph_Liouville_1868.jpg`（815×1055，已下载至 `images/Liouville_1868.jpg`），封面与身份信息页使用此肖像。
...
- [ ] **头像**：使用 1868 年肖像 `images/Liouville_1868.jpg`（815×1055 竖版）
- [ ] **国籍**：封面顶部徽章明示法国
