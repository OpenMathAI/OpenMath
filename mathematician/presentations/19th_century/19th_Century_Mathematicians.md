# 19 世纪数学史上的巨匠 — OpenMath 收录清单

> **本清单是 OpenMath 数学家立传项目的 19 世纪收录总表，非官方排名，而是按生年排序的收录清单。**
>
> 从 Gauss、Cauchy 到 Riemann、Cantor：奠定现代数学基础的大师们。
...
2. **生年上限**：生年均早于 1850 年，核心贡献在 19 世纪完成
...
| 13 | [Joseph Liouville](https://en.wikipedia.org/wiki/Joseph_Liouville) | 刘维尔 | 法国 | 1809–1882 | 刘维尔定理、超越数、刘维尔数 | 🔲 | 🔲 | ✅ |
| 14 | [Ernst Kummer](https://en.wikipedia.org/wiki/Ernst_Kummer) | 库默尔 | 德国 | 1810–1893 | 理想数、费马大定理、库默尔理论 | 🔲 | 🔲 | ✅ |
...
| 22 | [Leopold Kronecker](https://en.wikipedia.org/wiki/Leopold_Kronecker) | 克罗内克 | 德国 | 1823–1891 | 克罗内克 δ、代数数论、有限主义 | 🔲 | 🔲 | ✅ |
| 23 | [Bernhard Riemann](https://en.wikipedia.org/wiki/Bernhard_Riemann) | 黎曼 | 德国 | 1826–1866 | 黎曼几何、黎曼 ζ 函数、黎曼积分 | ✅ | 🔲 | 🔲 |
| 24 | [Richard Dedekind](https://en.wikipedia.org/wiki/Richard_Dedekind) | 戴德金 | 德国 | 1831–1916 | Dedekind 分割、Dedekind 环、代数数论 | ✅ | ✅ | ✅ |
| 25 | [Camille Jordan](https://en.wikipedia.org/wiki/Camille_Jordan) | 若尔当 | 法国 | 1838–1922 | Jordan 标准形、Jordan 闭曲线定理 | ✅ | 🔲 | ✅ |
| 26 | [Jean Gaston Darboux](https://en.wikipedia.org/wiki/Jean_Gaston_Darboux) | 达布 | 法国 | 1842–1917 | Darboux 积分、Darboux 定理 | ✅ | 🔲 | ✅ |
| 27 | [Sophus Lie](https://en.wikipedia.org/wiki/Sophus_Lie) | 索菲斯·李 | 挪威 | 1842–1899 | 李群、李代数 | 🔲 | 🔲 | 🔲 |
| 28 | [Georg Cantor](https://en.wikipedia.org/wiki/Georg_Cantor) | 康托尔 | 德国 | 1845–1918 | 集合论创始人 | ✅ | ✅ | ✅ |
| 29 | [Ferdinand Georg Frobenius](https://en.wikipedia.org/wiki/Ferdinand_Georg_Frobenius) | 弗罗贝尼乌斯 | 德国 | 1849–1917 | 弗罗贝尼乌斯自同态、群表示论 | ✅ | ✅ | 🔲 |
| 30 | [Felix Klein](https://en.wikipedia.org/wiki/Felix_Klein) | 克莱因 | 德国 | 1849–1925 | 爱尔兰根纲领、克莱因瓶 | ✅ | ✅ | ✅ |

## 三、目录对应关系

| 文件夹 | 中文名 |
|------|:--:|
| `Adrien-Marie_Legendre/` | 勒让德 |
| `Joseph_Fourier/` | 傅里叶 |
| `Sophie_Germain/` | 热尔曼 |
| `Carl_Friedrich_Gauss/` | 高斯 |
| `Bernhard_Bolzano/` | 波尔查诺 |
| `Siméon_Denis_Poisson/` | 泊松 |
| `Jean-Victor_Poncelet/` | 庞斯莱 |
| `Augustin-Louis_Cauchy/` | 柯西 |
| `Niels_Henrik_Abel/` | 阿贝尔 |
| `Carl_Gustav_Jacob_Jacobi/` | 雅可比 |
| `Peter_Gustav_Lejeune_Dirichlet/` | 狄利克雷 |
| `William_Rowan_Hamilton/` | 哈密顿 |
| `Joseph_Liouville/` | 刘维尔 |
| `Ernst_Kummer/` | 库默尔 |
| `Évariste_Galois/` | 伽罗瓦 |
| `James_Joseph_Sylvester/` | 西尔维斯特 |
| `George_Boole/` | 布尔 |
| `Karl_Weierstrass/` | 魏尔斯特拉斯 |
| `Arthur_Cayley/` | 凯莱 |
| `Charles_Hermite/` | 埃尔米特 |
| `Gotthold_Eisenstein/` | 艾森斯坦 |
| `Leopold_Kronecker/` | 克罗内克 |
| `Bernhard_Riemann/` | 黎曼 |
| `Richard_Dedekind/` | 戴德金 |
| `Camille_Jordan/` | 若尔当 |
| `Jean_Gaston_Darboux/` | 达布 |
| `Sophus_Lie/` | 索菲斯·李 |
| `Georg_Cantor/` | 康托尔 |
| `Ferdinand_Georg_Frobenius/` | 弗罗贝尼乌斯 |
| `Felix_Klein/` | 克莱因 |
