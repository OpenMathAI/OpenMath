...
3. **核心贡献概览**（`\hookslide`）：概率统计 / 势论方程 / 分析力学 / 物理 四分类
4. **早年与教育**（1781–1800）：Pithiviers、第一名入学、免试毕业、18 岁论文
5. **泊松斑（Arago spot）**（核心叙事页）：反驳波动说反证成真、Fresnel 获奖
6. **泊松分布与概率论**（核心贡献页）：新生儿男女比例、判断的概率
7. **泊松方程与势论**（核心贡献页）：∇²φ=−4πρ、启发 Green
8. **泊松括号与分析力学**（核心贡献页）：哈密顿力学核心工具、Jacobi 恒等式、狄拉克量子力学
9. **弹性与流体力学**：Navier–Stokes 方程、泊松比、发散定理特例
10. **电磁学与热传导**：势论、傅里叶级数采纳、泊松核
11. **荣誉与 Galois 互动**：Copley Medal、贵族院议员、对 Galois 的评审
