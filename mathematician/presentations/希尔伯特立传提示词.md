...
| 陷阱类型 | 希尔伯特特有的高危点 |
|---------|---------------------|
| **"最后一个数学全才"** | 参照对象是谁？Poincaré 也被称为"最后一个全才"。建议措辞："被广泛认为是 20 世纪最后一位数学全才。" |
...
| **纳粹清洗** | 1933 年大批犹太裔数学家被驱逐，包括 Emmy Noether, Richard Courant, Max Born 等。据说 Hilbert 在宴会上被问"Göttingen 数学现在怎么样了？"，他回答："已经没有数学了。" — 这个故事广为流传但史料存疑，加"据传"。 |
