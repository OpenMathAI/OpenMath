...
- **关键荣誉**：
  ...
  - 1937: 英国皇家学会外籍院士 (Foreign Member of the Royal Society)
  - 多项法国学术大奖 (Prix Poncelet, Prix Petit d'Ormoy 等)
  - 1940: 退休，离开索邦
- **重要合作者/学生**：
...
- 1888: 进入巴黎高等师范学校 (ENS)
- 1894: 完成博士论文，分类复单李代数（纠正了 Killing 的错误）
- 1894–1903: 在蒙彼利埃大学任教
- 1899–1904: 发展外微分形式和 Pfaff 方程组理论
- 1903–1909: 在里昂大学任教
- 1909–1912: 在南锡大学任教
- 1913: 发表 Cartan 子代数的核心论文
- 1912–1940: 在巴黎大学 (索邦) 任教授
- 1920s: 发展 Cartan 联络理论 —— 将其弟子 E. Cartan 的工作推广到联络的一般概念
- 1926–1935: 完成对称空间的系统分类
- 1930s: 活动标架法 (méthode du repère mobile) 成熟
- 1931: 当选法国科学院院士
...
| **任职机构时间线** | 蒙彼利埃→里昂→南锡→巴黎，顺序不能错 | page.md 搜索 "Montpellier" "Lyon" "Nancy" |
...
| **Weyl 的"丛林"评价** | 1949 年的原始出处 | page.md 搜索 "jungle" 或 "Weyl" |
