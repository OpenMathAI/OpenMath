...
9. ★ **Anthropic Claude — 比特之父的名字活在 AI 时代** — 2023 年，Anthropic 联合创始人 Dario Amodei 和 Daniela Amodei 将他们的旗舰 AI 助手命名为 "Claude"，向 Shannon 致敬。信息论之父的名字，如今驱动着最前沿的大语言模型。所以，每次你使用 Claude，你都在和 Shannon 的遗产对话
